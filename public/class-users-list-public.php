...
class Users_List_Public {
	...
	public function enqueue_styles() {
		 ...
		 * defined in Users_List_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The Users_List_Loader will then create the relationship
		 * between the defined hooks and the functions defined in this
		 * class.
		 */
		wp_enqueue_style( 'font-awesome-public', plugin_dir_url( __FILE__ ) . 'css/font-awesome.min.css', array(), $this->version, 'all' );
